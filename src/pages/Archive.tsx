...
export default function Archive({ setCurrentPage }: ArchiveProps) {
  return (
    <section id="archive" className="border-t border-b border-[#d3d8e2] dark:border-[#22252a] py-16 md:py-8 animate-fade-up">
