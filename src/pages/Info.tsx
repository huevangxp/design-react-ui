  ...
  return (
    <section id="info" className="flex flex-col gap-16 border-t border-b border-[#d3d8e2] dark:border-[#22252a] py-16 animate-fade-up select-none">
      ...
      <div className="flex flex-col gap-4">
        <div className="font-mono text-xs text-teal-600 dark:text-[#00b4d8] tracking-widest font-bold">// SYSTEM SPECS & SUPPORT //</div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 border-t border-[#d3d8e2] dark:border-[#22252a] pt-16">
        ...
        <div className="flex flex-col gap-6">
          <div className="flex flex-col gap-2">
            <span className="font-mono text-xs text-teal-600 dark:text-[#00b4d8] font-bold">// GET IN TOUCH</span>
            <h3 className="text-2xl font-black text-[#0f1013] dark:text-[#e2e4e9] tracking-tight">CONTACT PROJECT TERMINAL</h3>
          </div>
          
          <form onSubmit={(e) => e.preventDefault()} className="flex flex-col gap-5">
            <div className="flex flex-col gap-1.5">
              <label className="font-mono text-[11px] text-[#5a6270] dark:text-[#8b919d] tracking-wide">FULL_NAME /</label>
              <input 
                type="text" 
            ...
            <div className="flex flex-col gap-1.5">
              <label className="font-mono text-[11px] text-[#5a6270] dark:text-[#8b919d] tracking-wide">EMAIL_ADDRESS /</label>
              <input 
                type="email" 
            ...
            <div className="flex flex-col gap-1.5">
              <label className="font-mono text-[11px] text-[#5a6270] dark:text-[#8b919d] tracking-wide">MESSAGE /</label>
              <textarea 
                rows={4} 
        ...
        <div className="flex flex-col gap-8 bg-white dark:bg-[#14161b] border border-[#d3d8e2] dark:border-[#22252a] p-8 rounded-sm select-text hover:border-[#5a6270] dark:hover:border-[#8b919d] transition-all duration-200">
          <div className="flex flex-col gap-2 border-b border-[#d3d8e2] dark:border-[#22252a] pb-4">
            ...
            <h3 className="text-xl font-black text-[#0f1013] dark:text-[#e2e4e9] tracking-tight">PROJECT DIRECTIVES</h3>
          </div>
          ...
          <div className="flex flex-col gap-4 text-sm font-mono tracking-tight leading-relaxed">
            <div className="flex justify-between items-center border-b border-dashed border-[#e6e9ef] dark:border-[#1d2026] pb-3">
              <span className="text-[#5a6270] dark:text-[#8b919d]">OFFICE:</span>
              <span className="text-[#0f1013] dark:text-[#e2e4e9] font-bold">TOKYO HQ // DIRECTIVE 01</span>
            </div>
            ...
            <div className="flex justify-between items-center border-b border-dashed border-[#e6e9ef] dark:border-[#1d2026] pb-3">
              <span className="text-[#5a6270] dark:text-[#8b919d]">NETWORK STATUS:</span>
          ...
          <div className="border border-[#d3d8e2] dark:border-[#22252a] bg-[#f4f5f7] dark:bg-[#0c0d10] p-4 mt-2 font-mono text-[11px] text-[#5a6270] dark:text-[#8b919d] leading-relaxed rounded-sm select-none flex gap-3 items-start">
            ...
            <span>DISCLAIMER: SYSTEM MESSAGES MAY TAKE UP TO 24 HOURS FOR FULL DECRYPTION. OUR HIGH QUALITY OPERATIVES PROCESS EACH SUBMISSION INDIVIDUALLY.</span>
          </div>
        </div>
      </div>
    </section>
