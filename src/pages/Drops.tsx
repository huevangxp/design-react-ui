        ...
        <div className="flex gap-2">
          <button 
            className={`px-4 py-1.5 font-mono text-xs font-semibold cursor-pointer rounded-sm hover:bg-white dark:hover:bg-[#1d2026] hover:text-[#0f1013] dark:hover:text-[#e2e4e9] hover:border-teal-500 dark:hover:border-[#00b4d8] transition-all duration-200 border ${
              activeTab === 'ALL' ? 'bg-white dark:bg-[#1d2026] text-[#0f1013] dark:text-[#e2e4e9] border-teal-500 dark:border-[#00b4d8]' : 'bg-transparent border-[#d3d8e2] dark:border-[#22252a] text-[#5a6270] dark:text-[#8b919d]'
            }`} 
          ...
          <button 
            className={`px-4 py-1.5 font-mono text-xs font-semibold cursor-pointer rounded-sm hover:bg-white dark:hover:bg-[#1d2026] hover:text-[#0f1013] dark:hover:text-[#e2e4e9] hover:border-teal-500 dark:hover:border-[#00b4d8] transition-all duration-200 border ${
              activeTab === 'OUTERWEAR' ? 'bg-white dark:bg-[#1d2026] text-[#0f1013] dark:text-[#e2e4e9] border-teal-500 dark:border-[#00b4d8]' : 'bg-transparent border-[#d3d8e2] dark:border-[#22252a] text-[#5a6270] dark:text-[#8b919d]'
            }`} 
          ...
          <button 
            className={`px-4 py-1.5 font-mono text-xs font-semibold cursor-pointer rounded-sm hover:bg-white dark:hover:bg-[#1d2026] hover:text-[#0f1013] dark:hover:text-[#e2e4e9] hover:border-teal-500 dark:hover:border-[#00b4d8] transition-all duration-200 border ${
              activeTab === 'FOOTWEAR' ? 'bg-white dark:bg-[#1d2026] text-[#0f1013] dark:text-[#e2e4e9] border-teal-500 dark:border-[#00b4d8]' : 'bg-transparent border-[#d3d8e2] dark:border-[#22252a] text-[#5a6270] dark:text-[#8b919d]'
            }`} 
        ...
        {(activeTab === 'ALL' || activeTab === 'OUTERWEAR') && (
          <div className="bg-white dark:bg-[#14161b] border border-[#d3d8e2] dark:border-[#22252a] rounded overflow-hidden flex flex-col transition-all duration-300 hover:border-teal-500/50 dark:hover:border-teal-500/40 hover:-translate-y-1 hover:shadow-[0_8px_24px_rgba(0,0,0,0.15)] dark:hover:shadow-[0_8px_24px_rgba(0,0,0,0.4)] group animate-zoom-in">
            <div className="relative bg-[#e6e9ef] dark:bg-[#0f1013] w-full aspect-[4/5] overflow-hidden flex justify-center items-center">
              <div className="absolute top-4 left-4 font-mono bg-[#f4f5f7] dark:bg-[#0c0d10] border border-[#d3d8e2] dark:border-[#22252a] px-2.5 py-1 text-[10px] text-teal-600 dark:text-[#00b4d8] tracking-wider z-10 flex items-center gap-1">
              ...
              <div className="absolute -bottom-10 left-0 w-full bg-[#f4f5f7] dark:bg-[#0c0d10] border-t border-[#d3d8e2] dark:border-[#22252a] flex justify-center py-3 opacity-0 group-hover:bottom-0 group-hover:opacity-100 transition-all duration-300">
                <button className="bg-transparent border-none text-[#0f1013] dark:text-[#e2e4e9] font-mono text-xs font-bold cursor-pointer tracking-wide w-full hover:text-teal-600 dark:hover:text-[#00b4d8] transition-colors duration-200 flex items-center justify-center gap-2">
            ...
            <div className="p-5 flex flex-col gap-3 bg-white dark:bg-[#14161b]">
              <div className="flex justify-between items-center">
                ...
                <span className="text-[15px] font-bold text-teal-600 dark:text-[#00b4d8] font-bold">$145.00</span>
              </div>
          ...
          <div className="bg-white dark:bg-[#14161b] border border-[#d3d8e2] dark:border-[#22252a] rounded overflow-hidden flex flex-col transition-all duration-300 hover:border-teal-500/50 dark:hover:border-teal-500/40 hover:-translate-y-1 hover:shadow-[0_8px_24px_rgba(0,0,0,0.15)] dark:hover:shadow-[0_8px_24px_rgba(0,0,0,0.4)] group animate-zoom-in [animation-delay:150ms]">
            ...
            <div className="p-5 flex flex-col gap-3 bg-white dark:bg-[#14161b]">
              <div className="flex justify-between items-center">
                ...
                <span className="text-[15px] font-bold text-teal-600 dark:text-[#00b4d8] font-bold">$195.00</span>
              </div>
          ...
          <div className="bg-white dark:bg-[#14161b] border border-[#d3d8e2] dark:border-[#22252a] rounded overflow-hidden flex flex-col transition-all duration-300 hover:border-teal-500/50 dark:hover:border-teal-500/40 hover:-translate-y-1 hover:shadow-[0_8px_24px_rgba(0,0,0,0.15)] dark:hover:shadow-[0_8px_24px_rgba(0,0,0,0.4)] group animate-zoom-in [animation-delay:300ms]">
            ...
            <div className="p-5 flex flex-col gap-3 bg-white dark:bg-[#14161b]">
              <div className="flex justify-between items-center">
                ...
                <span className="text-[15px] font-bold text-teal-600 dark:text-[#00b4d8] font-bold">$220.00</span>
              </div>
