    ...
    <header className="flex justify-between items-center py-6 border-b border-[#e2e8f0] dark:border-[#22252a] font-mono text-[13px] animate-fade-up">
      ...
      <div className="flex items-center gap-4">
        ...
        <button 
          ...
          className="px-3 py-1.5 border border-[#e2e8f0] dark:border-[#22252a] bg-white dark:bg-[#1d2026] hover:bg-[#f8fafc] dark:hover:bg-[#2c313d] hover:shadow-sm text-[#0f1013] dark:text-[#e2e4e9] font-mono text-xs font-bold cursor-pointer transition-all duration-200 flex items-center justify-center hover:scale-105 rounded-sm select-none"
        ...
        <button 
          ...
          className="p-2 border border-[#e2e8f0] dark:border-[#22252a] bg-white dark:bg-[#1d2026] hover:bg-[#f8fafc] dark:hover:bg-[#2c313d] hover:shadow-sm text-[#0f1013] dark:text-[#e2e4e9] rounded-sm cursor-pointer transition-all duration-200 flex items-center justify-center hover:scale-105"
